export default function LogoStrip({ title = 'Backed by leaders', logos = ['/logos/a.svg', '/logos/b.svg', '/logos/c.svg', '/logos/d.svg'] }) {
  return (
    <section id="social_proof" className="border-t border-[color:var(--border-soft,#1E2430)] bg-[color:var(--bg-panel,#111317)]">
      <div className="mx-auto max-w-6xl px-4 py-10">
        <p className="mb-6 text-center text-sm text-[color:var(--text-secondary,#C9D2E1)]">{title}</p>
