...
export default function Tracks({ title = 'Tracks', subhead = 'Pick a lane and ship fast', cards = defaults }) {
  return (
    <section id="tracks" className="border-t border-[color:var(--border-soft,#1E2430)] bg-[color:var(--bg-base,#0A0B0E)]">
      <div className="mx-auto max-w-6xl px-4 py-16">
        ...
        <p className="mt-2 text-center text-[color:var(--text-secondary,#C9D2E1)]">{subhead}</p>
